...
_Note: Exact values depend on dataset used. Values shown are representative of synthetic data runs._
...
- Devlin, J., et al. (2019). BERT: Pre-training of Deep Bidirectional Transformers. _NAACL_.
